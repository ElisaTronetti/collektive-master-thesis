...
\textbf{Kotlin compiler plugins} are another metaprogramming alternative. As discussed previously in Section~\ref{section:compiler_plugin_explanation}, the development of a compiler plugin requires a lot of time and study, but it also provide a total freedom when trying to modify the code at compile time.
